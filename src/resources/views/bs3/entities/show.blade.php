...
@section('content')
    ...
    <ul class="list-inline">
        <li><a href="{{ route('crudgenerator.bs3.entities.edit', ['id' => $entity->id]) }}" class="btn btn-primary">{{ pxcg_trans('permaxis_crudgenerator::messages.edit') }}</a></li>
        <li><a href="{{ route('crudgenerator.bs3.entities.delete', ['id' => $entity->id]) }}" class="btn btn-default">{{ pxcg_trans('permaxis_crudgenerator::messages.delete') }}</a></li>
        <li><a href="{{ route('crudgenerator.bs3.entities.index') }}" class="btn btn-default">{{ pxcg_trans('permaxis_crudgenerator::messages.back_to_list') }}</a></li>
        <li></li>
    </ul>
@endsection