...
use Permaxis\CrudGenerator\App\Entities\Entity as ApiEntity;
...
class EntitiesController extends Controller
{
   ...
   /*bc*/   'name', /*ec*/
        ...
        //process  pagination
        $paginator = $this->processPagination($request, $entities, 'crudgenerator.entities.index');
    ...
    {
        $entity = ApiEntity::query()->find($id);
    ...
    public function destroyEntities(Request $request)
    {
        ...
        try {
            ...
            {
                $entity = ApiEntity::query()->find($entity['id']);
                $entity->delete();
            }
            $result = array(
                'status' => 'success',
