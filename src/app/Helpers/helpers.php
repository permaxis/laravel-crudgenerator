<?php
if (! function_exists('permaxis_sort_item')) {
    function permaxis_sort_item($sortBy, $sortDir, $key ) {
        $icon = (isset($sortBy) && $sortBy == $key && isset($sortDir) && $sortDir== 'desc')? 'glyphicon-chevron-down' : 'glyphicon-chevron-up' ;
        return " <i class=\"glyphicon {$icon} \"></i>";
    }
}
if (! function_exists('permaxis_inline_update_field')) {
    function permaxis_inline_update_field($path, $field_id, $field_name, $field_value, $field_formated_value = null, $field_updated_value = null ) {
